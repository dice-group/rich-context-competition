...
start_time3 = time()
fd = RasaDatasetExtraction(path='data/input/')
dataset_citations, dataset_mentions = fd.find_dataset()
fd.generate_dataset_citation(dataset_citations, output_path='data/output/')
fd.generate_dataset_mention(dataset_mentions, output_path='data/output/')
print(f"Found datasets in: {time() - start_time3} ") # time_taken is in seconds
